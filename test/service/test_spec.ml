...
((from macos-homebrew-ocaml-4.14)
 ...
 (run (cache (opam-archives (target /Users/mac1000/.opam/download-cache))
      ...
      (network host)
      (shell "cd ~/opam-repository && (git cat-file -e f207d3f018d642d1fcddb2c118e7fa8e65f4e366 || git fetch origin master) && git reset -q --hard f207d3f018d642d1fcddb2c118e7fa8e65f4e366 && git log --no-decorate -n1 --oneline"))
